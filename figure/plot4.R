...
##Create 4-plot panel (plot 4) in png file
...
#Top-right plot
plot(Feb07$Date_Time, Feb07$Voltage, type = "l", xlab = "datetime", ylab = "Voltage", 
     xaxt = "n")
r <- as.POSIXct(round(range(Feb07$Date_Time), "days"))
axis.POSIXct(1, at = seq(r[1], r[2], by = "days"), format = "%a")
...
##Bottom-right plot
plot(Feb07$Date_Time, Feb07$Global_reactive_power, type = "l", xlab = "datetime", 
